      ...
      >
        <div>
          ...
          <div className={classes.h1}>
            ...
            >
              <a
                href='https://drive.google.com/file/d/1dHXo6sQwUgcvCj57kzAMVZ5TlWzBX2U6/view?usp=drive_link'
        ...
        <div>
          ...
          <div className={classes.h2}>
            ...
            <h1>THINGS!!</h1>
            <a
              href='https://github.com/rohitzadavv/facerecognaisation-'
              rel='opener noreferrer'
              target='_blank'
            >
              view Face Recognaization app <GoProject />
            </a>
            <div className={classes.secondButton}>
              <a
                ...
                target='_blank'
              >
                VIEW Notepad-App PROJECTS <GoProject />
              </a>
            </div>
          </div>
        </div>
